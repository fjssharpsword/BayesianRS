...
def load_dataset(test_num=100):
    ...
    train_data = pd.read_csv("。/data/kbcc_trainset.csv", sep='|', low_memory=False, dtype={'csr':int, 'ke':int, 'num':float})
    ...
    test_data = pd.read_csv("。/data/kbcc_testset.csv", sep='|', low_memory=False, dtype={'csr':int, 'ke':int, 'num':float})
...
K          Iterations            HitRatio                NDCG
  8                  20            0.971809            0.855220
 16                  20            0.981989            0.873224
 32                  20            0.987275            0.884370
 64                  20            0.996378            0.909264
"""
